...
| verify  | *!verify*                      | Launches the verification system for the sender *(keep in mind this command can only be called in the verification channel and only by unverified members)*.                                                                          |
